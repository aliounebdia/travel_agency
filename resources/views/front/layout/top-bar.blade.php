<!-- Topbar Start -->
<div id="accueil" class="container-fluid bg-dark px-5 d-none d-lg-block">
    <div class="row gx-0">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Dakar Plateau, Sénégal</small>
                <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+221 76 163 35 73</small>
                <small class="text-light"><i class="fa fa-envelope-open me-2"></i>info@av-group.com</small>
            </div>
        </div>
